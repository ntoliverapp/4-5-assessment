...
def sales_reports(log_file): # this line is defining a function called 'sales_reports' that will take in a parameter called 'log_file' as lines of text from 'um-server-01'
    for line in log_file: #this is running the for loop command; looping the iterable 'line' through each line of text in 'log file'
        ...
        day = line[0:3] # this line is describing the 'day' variable
